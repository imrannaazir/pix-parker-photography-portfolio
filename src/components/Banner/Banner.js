            ...
            <div className=' relative'>
                ...
                <div className=' absolute top-40 left-32 text-white '>
                    <div className='motion-safe:animate-bounce'>
                        <p className=' text-4xl text-[#DF1F2D]'>Hello</p>
                        <p className='text-8xl font-semibold'>I'm Peter Parker.</p>
                        <p className=' text-2xl font-serif text-gray-200'>I'm proving Photograph & Videograph of my friend, Spiderman!</p>
