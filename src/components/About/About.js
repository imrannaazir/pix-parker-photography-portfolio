...
const About = () => {
    return (
        <div>
            <div className=' relative w-full h-[300px] bg-gradient-to-r from-gray-500 to-red-500'>
                <img className=' absolute left-36 top-12 w-[300px] rounded-xl shadow-xl' src={me} alt="" />
                <div className=' absolute left-[470px] lg:left-[600px]  top-12 text-white'>
